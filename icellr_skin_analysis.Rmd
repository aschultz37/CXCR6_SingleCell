---
title: "iCellR Skin (CXCR6) scRNA-seq Analysis"
...
Load the pre-processed Robj file into iCellR object.
```{r load_scobj}
load("data/my.obj.Robj")
```

Make plots for gene signatures.
```{r gene_plots, warning=FALSE}
gene.plot(my.obj, gene=LN_Trm_genes, plot.type="scatterplot", interactive=FALSE,
          plot.data.type="umap")
gene.plot(my.obj, gene=TGFb_genes, plot.type="scatterplot", interactive=FALSE,
          plot.data.type="umap")
```
